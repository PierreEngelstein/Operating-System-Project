...
;----------Includes needed----------
%include "src/arch/x86_64/boot/print.asm"
%include "src/arch/x86_64/boot/mem.asm"
%include "src/arch/x86_64/boot/string_ctes.asm"
%include "src/arch/x86_64/boot/ct.asm"
%include "src/arch/x86_64/boot/gdt.asm"
%include "src/arch/x86_64/boot/switch_32.asm"
;-----------------------------------
